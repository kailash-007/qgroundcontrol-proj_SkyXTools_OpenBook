...
#include "SkyXTools/skyxmanager.h"
...
public:
    ...
    Q_PROPERTY(SkyXManager*         skyxmanager             READ    skyXManager             CONSTANT)
    ...
    SkyXManager*            skyXManager         ()  { return _skyXManager; }
...
private:
    ...
    SkyXManager*            _skyXManager            = nullptr;
#ifndef QGC_NO_SERIAL_LINK
